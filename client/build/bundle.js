...
/***/ function(module, exports, __webpack_require__) {
	...
	var BankBox = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var SampleData = __webpack_require__(169);
	var BankTotal = __webpack_require__(170);
	var AccountsBox = __webpack_require__(172);
	var InterestSelector = __webpack_require__(174);
	var Bank = __webpack_require__(175);
	...
	var BankBox = React.createClass({
	  ...
	  handleInterestSelector: function handleInterestSelector(interestRate, accountType) {
	    var bank = new Bank();
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        'div',
	        { id: 'shadow' },
	        React.createElement(BankTotal, { id: 'total', bankTotal: bank.totalCash() }),
	        React.createElement(AccountsBox, { 'class': 'accounts_box', type: 'Business', total: bank.totalCash('business'), accounts: bank.filteredAccounts('business') }),
	        React.createElement(AccountsBox, { type: 'Personal', total: bank.totalCash('personal'), accounts: bank.filteredAccounts('personal') }),
	        React.createElement(InterestSelector, { onCalculate: this.handleInterestSelector })
	      )
	    );
	  }
	});
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        null,
	        ' Bank Total: ',
	        helpers.numberAsCurrency(this.props.bankTotal),
	        ' '
	      )
	    );
	  }
...
/***/ function(module, exports) {
	...
	module.exports = {
	  numberAsCurrency: function numberAsCurrency(number) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var AccountsList = __webpack_require__(173);
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.props.type,
	        ' Accounts Total : ',
	        this.props.total.toLocaleString('gbr-GBR', { style: 'currency', currency: 'GBP' })
	      ),
	      React.createElement(AccountsList, { accounts: this.props.accounts })
	    );
	  }
	});
	  ...
	  render: function render() {
	    var listItems = this.props.accounts.map(function (account, index) {
	      return React.createElement(
	        ...
	        { key: index },
	        ' Owner: ',
	        helpers.capitalize(account.owner),
	        ' - Balance: ',
	        helpers.numberAsCurrency(account.amount),
	        ' '
	      );
	    });
	    return React.createElement(
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        React.createElement('input', { id: 'input', name: 'interestRate', type: 'number' }),
	        React.createElement(
	          'p',
	          null,
	          '% Interest on '
...
/***/ function(module, exports) {
	...
	Bank.prototype = {
	  ...
	  payInterest: function payInterest(interestPercentage, accountType) {
	    var _iteratorNormalCompletion4 = true;
	    var _didIteratorError4 = false;
	    var _iteratorError4 = undefined;
	
	    try {
	      for (var _iterator4 = this.filteredAccounts(accountType)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
